    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm border-l-4 border-l-indigo-600">
        ...
        <div className="flex items-end justify-between">
          <span className={`text-2xl font-black ${daysToEvent <= 7 ? 'text-red-600' : 'text-slate-900'}`}>
        ...
        <p className="text-[10px] text-slate-400 mt-1">Target: Feb 17, 2025</p>
      </div>
