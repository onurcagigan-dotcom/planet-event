    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center animate-in fade-in zoom-in duration-300 border border-slate-100">
        ...
        <button 
          ...
          className="w-full bg-indigo-50 border-2 border-indigo-100 text-indigo-700 py-4 rounded-2xl font-black text-sm hover:bg-indigo-100 transition-all uppercase tracking-widest mb-6 flex items-center justify-center gap-3"
        >
        ...
        <div className="mt-8 pt-6 border-t border-slate-50">
           <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
            PLANET - CLOUD PERSISTENCE ACTIVE
          </p>
        </div>
      </div>
    </div>
